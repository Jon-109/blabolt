...
const faqs = [
  ...
  },
  {
    ...
    a: 'You receive access to complete the Personal Debt Summary workflow and generate a polished PDF that is ready for immediate download and lender review.',
  },
  {
  ...
  },
  {
    ...
    a: `Yes. This page is for the single Personal Debt Summary template at ${formatUsd(TEMPLATE_UNIT_PRICE_CENTS)}. If you later want everything, the full bundle is ${formatUsd(TEMPLATE_BUNDLE_PRICE_CENTS)} one-time.`,
  },
  {

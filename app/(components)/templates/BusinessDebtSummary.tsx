    ...
    <PrintShell title={`Business Debt Summary — As of ${data.asOfDate}`}>
      <section style={{ marginBottom: 16 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, fontSize: 11 }}>
          ...
          {data.businessInfo.ein && <div><strong>EIN:</strong> {data.businessInfo.ein}</div>}
        </div>
      </section>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 10 }}>
              <thead>
                <tr style={{ backgroundColor: '#f8f9fa' }}>
                  ...
                  <th style={{ padding: '8px 4px', textAlign: 'center', borderBottom: '2px solid #333', fontWeight: 'bold' }}>Personal Guarantee</th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr style={{ backgroundColor: '#f8f9fa' }}>
                  ...
                  <td style={{ padding: '8px 4px', borderTop: '2px solid #333' }} colSpan={4}></td>
                </tr>
              </tbody>
            </table>
          </div>

      ...
      <div className="max-w-5xl mx-auto p-6 space-y-8">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <FormField
              label="SSN (Optional)"
              help="Used for lender verification if needed. You can leave this blank."
            >
              <Input
                type="text"
                placeholder="XXX-XX-XXXX"
                className="w-full"
                value={form.personalInfo.ssn || ''}
                onChange={(e) => updateForm('personalInfo.ssn', e.target.value)}
              />
            </FormField>
            <FormField
              label="As of Date"
              ...
              {form.debts.map((debt, index) => (
                <div key={index} className="border-2 border-gray-200 rounded-xl p-6 relative">
                  ...
                  <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <FormField label="Creditor Name" required help="Bank, credit card, lender, or other creditor.">
                      <Input
                        type="text"
                        placeholder="Bank, Credit Card, etc."
                        className="w-full"
                        value={debt.creditor}
                        onChange={(e) => updateDebt(index, 'creditor', e.target.value)}
                      />
                    </FormField>
                    <FormField label="Account Number" help="You may enter only the last 4 digits for privacy.">
                      <Input
                        type="text"
                    ...
                    <FormField label="Original Amount" required help="The amount originally borrowed or charged.">
                      <Input
                        type="number"
                        step="0.01"
                        placeholder="$0.00"
                    ...
                    <FormField label="Current Balance" required help="What you owe today.">
                      <Input
                        type="number"
                        step="0.01"
                        placeholder="$0.00"
                    ...
                    <FormField label="Monthly Payment" required help="Your usual monthly payment amount.">
                      <Input
                        type="number"
                        step="0.01"
                        placeholder="$0.00"
                    ...
                    <FormField label="Maturity Date" help="If this debt has an end date.">
                      <Input
                        type="date"
                        className="w-full"
                    ...
                    <div className="lg:col-span-2">
                      <FormField label="Collateral" help="If this debt is secured by property (house, car, etc.).">
                        <Input
                          type="text"
                          placeholder="House, car, or other secured asset"
                          className="w-full"
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
          ...
          <FormField label="Notes" help="Add context about your debts, payment history, or anything else helpful for reviewers.">
            <Textarea
              rows={4}

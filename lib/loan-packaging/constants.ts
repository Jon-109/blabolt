...
export const DEFAULT_REQUIREMENT_ROWS: DocumentRequirementSeed[] = [
  ...
  },
  {
    ...
    description: 'Current SBA Form 413 personal financial statement for guarantor assets, liabilities, income, and contingent obligations.',
    required: true,
    sort_order: 20,
  ...
  {
    requirement_key: 'additional_supporting_documents',
    service_type: 'loan_packaging',
    loan_purpose: null,
    category: 'other',
    display_name: 'Additional Supporting Documents',
    description:
  ...
  {
    requirement_key: 'additional_supporting_documents_2',
    service_type: 'loan_packaging',
    loan_purpose: null,
    category: 'other',
    display_name: 'Additional Supporting Documents 2',
    description: 'Optional extra slot for another supporting file the lender may find useful.',
    required: false,
    sort_order: 901,
    template_key: null,
    max_size_mb: 50,
  ...
  {
    requirement_key: 'additional_supporting_documents_3',
    service_type: 'loan_packaging',
    loan_purpose: null,
    category: 'other',
    display_name: 'Additional Supporting Documents 3',
    description: 'Optional extra slot for another supporting file the lender may find useful.',
    required: false,
    sort_order: 902,
    template_key: null,

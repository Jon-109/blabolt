...
export const DEFAULT_REQUIREMENT_ROWS: DocumentRequirementSeed[] = [
  ...
  purposeRequirement(
    ...
    'Working Capital',
    'Business Bank Statements / Account Analysis',
    'Provide 3 to 6 months of business bank statements or an account analysis statement.',
    210,
    'bank_statement',
    50,
    ['application/pdf'],
  ...
  purposeRequirement(
    'equipment_purchase_specs',
    'Equipment Purchase',
    'Equipment Specs',
    'Manufacturer specifications, model details, or technical information for the equipment.',
    221,
  ),
  purposeRequirement(
  ...
  purposeRequirement(
    'inventory_purchase_seasonality_explanation',
    'Inventory Purchase',
    'Seasonality Explanation',
    'Narrative explaining inventory timing, seasonal demand, and expected turnover.',
    232,
  ),
  purposeRequirement(
  ...
  purposeRequirement(
    'business_acquisition_valuation',
    'Business Acquisition',
    'Valuation',
    'Valuation support for the transaction price and business worth.',
    242,
  ),
  purposeRequirement(
  ...
  purposeRequirement(
    'expansion_staffing_plan',
    'Business Expansion / New Location',
    'Hiring / Staffing Plan',
    'Staffing plan for the expansion, including headcount needs and timing.',
    283,
  ),
  purposeRequirement(
    'expansion_market_rationale',
    'Business Expansion / New Location',
    'Market Rationale',
    'Narrative supporting market demand, location fit, and expansion logic.',
    284,
  ),
  purposeRequirement(
    'expansion_licenses',
    'Business Expansion / New Location',
    'Licenses / Permits',
    'Relevant licenses or regulatory approvals for the expansion, if applicable.',
    285,
  ),
  purposeRequirement(
  ...
  purposeRequirement(
    'tenant_improvement_contingency_budget',
    'Tenant Improvements / Renovation',
    'Contingency Budget',
    'Budget buffer for overruns, change orders, and unforeseen renovation costs.',
    294,
  ),
  purposeRequirement(
    'tenant_improvement_permits',
    'Tenant Improvements / Renovation',
    'Permits',
    'Relevant permits or permit application evidence, if applicable.',
    295,
  ),
  purposeRequirement(
  ...
  purposeRequirement(
    'partner_buyout_transfer_docs',
    'Partner Buyout',
    'Ownership Transfer Documents',
    'Documents supporting the ownership transfer and resulting structure.',
    304,
  ),
  purposeRequirement(
  ...
  purposeRequirement(
    'bridge_collateral_support',
    'Bridge Financing',
    'Collateral Support',
    'Collateral documentation supporting the bridge request.',
    322,
  ),
  purposeRequirement(
  ...
  purposeRequirement(
    'revolving_loc_borrowing_base',
    'Revolving Line of Credit',
    'Borrowing-Base Support',
    'Borrowing-base calculation or support schedule for the line request.',
    334,
  ),
  purposeRequirement(
